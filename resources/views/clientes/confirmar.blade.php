        ...
        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Esta de acuerdo en eliminar al cliente?</h3>
                    <form method="POST" action="{{route('clientes.destroy',$clientes->idcliente)}}">
                        @method('delete')
                        @csrf
                        <div class="grid md:grid-cols-6 md:gap-6">
                            <div class="relative z-0 mb-6 w-full group">
                                <p>Nombre:</p>
                                <input type="tel" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" id="nombrep" name="nombrep" value="{{ $clientes->nombrec}}" disabled>
